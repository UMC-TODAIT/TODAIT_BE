...
public enum CourseErrorCode implements BaseErrorCode {
    ...
    ORDERING_ENTRY_INVALID_BASE_PLACE(HttpStatus.CONFLICT, "BASE_PLACE409", "기준 장소 구성 정보가 올바르지 않습니다."),
    ORDERING_ENTRY_SELECTED_PLACE_REQUIRED(HttpStatus.CONFLICT, "COURSE_PLACE409", "순서를 설정하려면 장소를 하나 이상 추가해야 합니다."),
    ORDERING_ENTRY_INVALID_VISIT_ORDER(HttpStatus.CONFLICT, "COURSE_PLACE409_1", "장소 방문 순서 정보가 올바르지 않습니다."),
