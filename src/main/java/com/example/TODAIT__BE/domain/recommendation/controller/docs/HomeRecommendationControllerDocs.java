...
public interface HomeRecommendationControllerDocs {
    ...
    @Operation(
            summary = "[홈 추천] 홈 추천 장소 목록 조회",
            description = """
                    홈 화면의 추천 장소 영역에 표시할 운영자 관리 장소 목록을 조회합니다.

                    - 위치정보 있음: 500m 이내 여부, 거리, 운영자 우선순위 기준 정렬
                    - 위치정보 없음: 홍대·성수·연남 지역별 라운드 로빈 구성
                    - cursor가 없으면 첫 목록을 반환합니다.
                    - size 기본값은 2, 허용 범위는 1~20입니다.
