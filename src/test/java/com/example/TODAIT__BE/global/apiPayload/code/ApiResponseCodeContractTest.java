...
class ApiResponseCodeContractTest {
    ...
    private static final List<CodeEnum> CODE_ENUMS = List.of(
            ...
            new CodeEnum(CourseDraftSuccessCode.class, Set.of("COURSE")),
            new CodeEnum(CourseDraftErrorCode.class, Set.of("COURSE")),
            new CodeEnum(CourseSaveSuccessCode.class, Set.of("COURSE")),
            new CodeEnum(CourseSaveErrorCode.class, Set.of("COURSE")),
            new CodeEnum(RecommendedCourseSuccessCode.class, Set.of("COURSE")),
    ...
    private static final Map<String, String> EXPECTED_CODES = Map.ofEntries(
            ...
            entry("CourseDraftSuccessCode.COURSE_DRAFT_CREATE_OK", "COURSE201"),
            entry("CourseDraftSuccessCode.MOOD_TAG_SAVE_OK", "COURSE200_1"),
            entry("CourseDraftSuccessCode.FOOD_CATEGORY_SAVE_OK", "COURSE200_2"),
            entry("CourseDraftSuccessCode.PLACE_ORDER_UPDATE_OK", "COURSE200"),
            entry("CourseDraftSuccessCode.ORDERING_ENTRY_OK", "COURSE200_9"),
            entry("CourseDraftSuccessCode.COURSE_DRAFT_SAVING_ENTER_OK", "COURSE200_8"),
            entry("CourseDraftSuccessCode.BASE_PLACE_SAVE_OK", "COURSE200_6"),
            ...
            entry("SavedCourseSuccessCode.SAVED_COURSE_OVERVIEW_OK", "COURSE200_4"),
            entry("SavedCourseSuccessCode.SAVED_COURSE_DETAIL_OK", "COURSE200_5"),
            entry("SavedCourseSuccessCode.SAVED_COURSE_DELETE_OK", "COURSE200_7"),
            entry("SavedCourseSuccessCode.SAVED_COURSE_MEMO_UPDATE_OK", "COURSE200_10"),
            entry("SavedCourseSuccessCode.SAVED_COURSE_PLACE_MEMO_UPDATE_OK", "COURSE200_11"),
            entry("CourseDraftErrorCode.COURSE_DRAFT_NOT_FOUND", "COURSE_DRAFT404"),
            entry("CourseDraftErrorCode.COURSE_DRAFT_ACCESS_DENIED", "COURSE403_1"),
            entry("CourseDraftErrorCode.INVALID_MOOD_TAG_COUNT", "COURSE_MOOD400"),
            entry("CourseDraftErrorCode.DUPLICATE_MOOD_TAG", "COURSE400_2"),
            entry("CourseDraftErrorCode.MOOD_TAG_DRAFT_STATUS_CONFLICT", "COURSE_MOOD409"),
            entry("CourseDraftErrorCode.INVALID_FOOD_CATEGORY_COUNT", "COURSE400_3"),
            entry("CourseDraftErrorCode.DUPLICATE_FOOD_CATEGORY", "COURSE400_4"),
            entry("CourseDraftErrorCode.FOOD_CATEGORY_DRAFT_STATUS_CONFLICT", "COURSE_FOOD409"),
            entry("CourseDraftErrorCode.INVALID_BASE_PLACE", "COURSE_BASE400"),
            entry("CourseDraftErrorCode.INVALID_SELECTED_PLACE", "COURSE_PLACE400"),
            entry("CourseDraftErrorCode.COURSE_DRAFT_STATUS_CONFLICT", "COURSE_DRAFT409"),
            entry("CourseDraftErrorCode.COURSE_DRAFT_BASE_PLACE_CONFLICT", "COURSE_BASE409"),
            entry("CourseDraftErrorCode.COURSE_DRAFT_SELECTED_PLACE_CONFLICT", "COURSE_PLACE409"),
            entry("CourseDraftErrorCode.SELECTED_PLACE_NOT_FOUND", "COURSE_PLACE404"),
            entry("CourseDraftErrorCode.BASE_PLACE_NOT_REORDERABLE", "COURSE_BASE_REORDER400"),
            entry("CourseDraftErrorCode.INVALID_VISIT_ORDER", "COURSE_ORDER400"),
            entry("CourseDraftErrorCode.PLACE_ORDER_DRAFT_STATUS_CONFLICT", "COURSE_ORDER409"),
            entry("CourseDraftErrorCode.ORDERING_ENTRY_STATUS_CONFLICT", "COURSE409"),
            entry("CourseDraftErrorCode.ORDERING_ENTRY_INVALID_BASE_PLACE", "COURSE_BASE409_1"),
            entry("CourseDraftErrorCode.ORDERING_ENTRY_SELECTED_PLACE_REQUIRED", "COURSE_PLACE409_1"),
            entry("CourseDraftErrorCode.ORDERING_ENTRY_INVALID_VISIT_ORDER", "COURSE_PLACE409_2"),
            entry("CourseDraftErrorCode.BASE_PLACE_DRAFT_STATUS_CONFLICT", "COURSE_BASE409_2"),
            entry("CourseDraftErrorCode.BASE_PLACE_SOURCE_CONFLICT", "COURSE400_6"),
            entry("CourseDraftErrorCode.BASE_PLACE_SOURCE_MISSING", "COURSE400_7"),
            entry("CourseDraftErrorCode.PLACE_ADD_DRAFT_STATUS_CONFLICT", "COURSE_PLACE409_3"),
            entry("CourseDraftErrorCode.BASE_PLACE_RESELECT_CONFLICT", "COURSE_PLACE409_4"),
            entry("CourseDraftErrorCode.SELECTED_PLACE_DUPLICATE", "COURSE_PLACE409_5"),
            ...
            entry("PlaceSearchErrorCode.INVALID_PLACE_SEARCH_CURSOR", "PLACE400_6"),
            entry("PlaceSearchErrorCode.INVALID_PLACE_SEARCH_SIZE", "PLACE400_7"),
