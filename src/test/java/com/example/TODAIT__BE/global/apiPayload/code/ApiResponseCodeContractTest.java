...
class ApiResponseCodeContractTest {
    ...
    private static final Map<String, String> EXPECTED_CODES = Map.ofEntries(
            ...
            entry("CourseSuccessCode.SAVED_COURSE_MEMO_UPDATE_OK", "COURSE200_10"),
            entry("CourseSuccessCode.SAVED_COURSE_PLACE_MEMO_UPDATE_OK", "COURSE200_11"),
            entry("CourseErrorCode.SAVED_COURSE_PLACE_NOT_FOUND", "COURSE_PLACE404_1"),
            ...
            entry("CourseErrorCode.PLACE_ADD_DRAFT_STATUS_CONFLICT", "COURSE_PLACE409_3"),
            entry("CourseErrorCode.BASE_PLACE_RESELECT_CONFLICT", "COURSE_PLACE409_4"),
            entry("CourseErrorCode.SELECTED_PLACE_DUPLICATE", "COURSE_PLACE409_5"),
            entry("CourseErrorCode.SELECTED_PLACE_CATEGORY_DUPLICATE", "COURSE_PLACE409_6"),
