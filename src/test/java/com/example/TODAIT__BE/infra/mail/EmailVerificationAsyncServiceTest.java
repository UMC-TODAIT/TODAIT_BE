...
class EmailVerificationAsyncServiceTest {
    ...
    void sendVerificationCodeAsyncDelegatesToMailSender() {
        EmailVerificationAsyncService asyncService = new EmailVerificationAsyncService(
                mailSender,
                emailVerificationStore
        );

        asyncService.sendVerificationCode("test@example.com", "123456");
        ...
        verify(emailVerificationStore, never()).deleteCodeAndCooldownIfMatches(anyString(), anyString());
    }
    ...
    void sendVerificationCodeAsyncDoesNotPropagateMailFailure() {
        ...
        assertThatCode(() -> asyncService.sendVerificationCode("test@example.com", "123456"))
                .doesNotThrowAnyException();
        verify(emailVerificationStore).deleteCodeAndCooldownIfMatches("test@example.com", "123456");
    }
}
